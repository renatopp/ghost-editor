(function() {
  ...
  angular
    .module('app')
    .directive('propIntegerrange', IntegerrangeDirective);

  IntegerrangeDirective.$inject = ['$parse'];
  function IntegerrangeDirective($parse) {
    var directive = {
      require     : 'ngModel',
      restrict    : 'E',
      templateUrl : 'properties/integerrange.property.html',
      link        : linkFunction,
    };
    return directive;
